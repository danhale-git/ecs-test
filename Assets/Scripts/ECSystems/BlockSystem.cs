...
public class BlockSystem : ComponentSystem
{
	...
	ArchetypeChunkBufferType<MyComponents.Topology> 	heightmapType;
	...
	protected override void OnUpdate()
	{
        ...
        heightmapType = GetArchetypeChunkBufferType<MyComponents.Topology>();
	...
	void GenerateCubes(NativeArray<ArchetypeChunk> chunks)
	{
		...
		for(int c = 0; c < chunks.Length; c++)
		{
            ...
            BufferAccessor<MyComponents.Topology> heightmapAccessor 	= chunk.GetBufferAccessor(heightmapType);
			...
			for(int e = 0; e < entities.Length; e++)
			{
                ...
                DynamicBuffer<MyComponents.Topology> heightmap		= heightmapAccessor[e];
	...
	NativeArray<Block> GetBlocks(int batchSize, int blockArrayLength, NativeArray<MyComponents.Topology> heightMap, NativeArray<MapCube> cubes)
	{
